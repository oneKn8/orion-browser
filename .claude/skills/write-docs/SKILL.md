---
name: write-docs
description: Write Orion feature documentation. Use when the user wants to create or update documentation for a Orion feature. This skill explores the codebase to understand features and writes concise Mintlify MDX docs.
allowed-tools: Read, Grep, Glob, Bash, Task, Write, Edit
---

# Write Orion Documentation

This skill helps write documentation for Orion features. It follows a structured workflow to create high-quality, concise documentation pages.
...
2. **Search the codebase** at `../orion-server` (sibling directory) to find relevant code:
...
- **Clear**: Write for first-time Orion users
...
---
title: "Ad Blocking"
description: "Orion blocks 10x more ads than Chrome out of the box"
---

Orion ships with built-in ad blocking that works immediately—no extensions required.
...
- **Docs location**: `docs/`
- **Images**: `docs/images/`
- **Feature code**: `../orion-server/` (sibling directory)
...
1. Orion MCP Server
2. Connecting other MCPs to Orion assistant
3. Scheduled tasks
