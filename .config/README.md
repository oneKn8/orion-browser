...
1. Creates new worktree at `../orion-main.feat-name/`
2. Runs `bun install` in `packages/orion-agent/`
3. Copies `.env.*` files from main worktree's `packages/orion-agent/apps/`
