...
Browser automation SDK for Orion — navigate, interact, extract data, and verify page state using natural language.

## Installation

```bash
npm install @oneKn8/agent-sdk
# or
bun add @oneKn8/agent-sdk
```

## Quick Start

```typescript
import { Agent } from '@oneKn8/agent-sdk'
import { z } from 'zod'
