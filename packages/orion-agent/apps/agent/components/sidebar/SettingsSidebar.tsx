...
import { Feature } from '@/lib/orion/capabilities'
import { useCapabilities } from '@/lib/orion/useCapabilities'
...
const primarySettingsSections: NavSection[] = [
  {
    ...
    items: [
      { name: 'Orion AI', to: '/settings/ai', icon: Bot },
      {
  ...
  },
  {
    ...
    items: [
      {
        name: 'Customize Orion',
        to: '/settings/customization',
        icon: Palette,
        feature: Feature.CUSTOMIZATION_SUPPORT,
      },
      { name: 'Orion as MCP', to: '/settings/mcp', icon: Server },
      {
        name: 'Workflows',
        to: '/workflows',
        icon: GitBranch,
...
const helpItems: NavItem[] = [
  { name: 'Docs', href: 'https://docs.orion-browser.local/', icon: BookOpen },
