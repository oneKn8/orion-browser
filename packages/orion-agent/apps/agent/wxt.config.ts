...
const apiUrl = new URL(env.VITE_PUBLIC_ORION_API!)
...
export default defineConfig({
  ...
  manifest: {
    ...
    update_url: 'https://cdn.orion-browser.local/extensions/update-manifest.xml',
    // update_url: 'https://cdn.orion-browser.local/extensions/update-manifest.alpha.xml',
