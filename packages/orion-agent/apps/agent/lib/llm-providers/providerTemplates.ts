...
export const providerTemplates: ProviderTemplate[] = [
  ...
  },
  {
    ...
    setupGuideUrl:
      'https://docs.orion-browser.local/features/bring-your-own-llm#openai',
  },
  {
  ...
  },
  {
    ...
    setupGuideUrl:
      'https://docs.orion-browser.local/features/bring-your-own-llm#claude',
  },
  {
    id: 'google',
    name: 'Gemini',
    ...
    setupGuideUrl:
      'https://docs.orion-browser.local/features/bring-your-own-llm#gemini',
  },
  {
    id: 'ollama',
    name: 'Ollama',
    ...
    contextWindow: 128000,
    setupGuideUrl:
      'https://docs.orion-browser.local/features/bring-your-own-llm#ollama',
  },
  {
    id: 'openrouter',
    name: 'OpenRouter',
    ...
    setupGuideUrl:
      'https://docs.orion-browser.local/features/bring-your-own-llm#openrouter',
  },
  {
    id: 'lmstudio',
    name: 'LM Studio',
    ...
    contextWindow: 32000,
    setupGuideUrl:
      'https://docs.orion-browser.local/features/bring-your-own-llm#lmstudio',
  },
  {
    id: 'azure',
    name: 'Azure',
