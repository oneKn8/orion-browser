...
/**
 * Action for Orion chat/agent queries
 * @public
 */
export interface OrionAction extends BaseChatAction {
  type: 'orion'
  mode: 'chat' | 'agent'
  message: string
  tabs?: chrome.tabs.Tab[]
 ...
 * @public
 */
export type ChatAction = AITabAction | OrionAction
...
/**
 * Helper to create a Orion action
 * @public
 */
export const createOrionAction = (params: {
  mode: 'chat' | 'agent'
  message: string
  tabs?: chrome.tabs.Tab[]
}): OrionAction => ({
