...
import { OrionIcon, ProviderIcon } from '@/lib/llm-providers/providerIcons'
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {isBuiltIn && provider.type === 'orion' && kimiLaunch && (
        ...
        <p className="truncate text-muted-foreground text-sm">
          {isBuiltIn ? (
            kimiLaunch ? (
              ...
              <>
                Orion-hosted model with strict rate limits.{' '}
                <a
                  href="https://docs.orion-browser.local/features/bring-your-own-llm"
                  target="_blank"
