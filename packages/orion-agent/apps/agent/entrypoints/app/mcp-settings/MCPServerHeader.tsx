...
const DOCS_URL = 'https://docs.orion-browser.local/features/use-with-claude-code'

export const MCPServerHeader: FC<MCPServerHeaderProps> = ({
  serverUrl,
  isLoading,
  error,
  title = 'Orion MCP Server',
  description = 'Connect Orion to MCP clients like claude code, gemini and others.',
