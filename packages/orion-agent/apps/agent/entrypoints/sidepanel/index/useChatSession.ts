...
import { useAgentServerUrl/useOrionProviders'
...
import { createDefaultOrionProvider } from '@/lib/llm-providers/storage'
  ...
  const {
    ...
    transport: new DefaultChatTransport({
      ...
      prepareSendMessagesRequest: async ({ messages }) => {
        ...
        const provider =
          selectedLlmProviderRef.current ?? createDefaultOrionProvider()
