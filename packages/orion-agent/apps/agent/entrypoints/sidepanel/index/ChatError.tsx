...
function parseErrorMessage(message: string): {
  ...
  if (
    ...
    return {
      text: 'Unable to connect to Orion agent. Follow below instructions.',
      url: 'https://docs.orion-browser.local/troubleshooting/connection-issues',
      isConnectionError: true,
    }
  }

  // Detect Orion rate limit (unique pattern, no provider uses this)
  if (message.includes('Orion LLM daily limit reached')) {
    return {
      text: 'Add your own API key for unlimited usage.',
      url: 'https://dub.sh/orion-usage-limit',
      isRateLimit: true,
    }
  }
      ...
      {isRateLimit && (
        <div className="flex flex-col items-center gap-1">
          <p className="text-muted-foreground text-xs">
            ...
            <a
              href="https://docs.orion-browser.local/features/bring-your-own-llm#kimi-k2-5-%E2%80%94-in-partnership-with-moonshot-ai"
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:text-foreground"
