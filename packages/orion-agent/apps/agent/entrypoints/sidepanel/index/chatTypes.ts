...
export const AGENT_SUGGESTIONS: Suggestion[] = [
  {
    ...
    prompt:
      'Go to https://dub.sh/orion-launch in current tab. Find and click the upvote button',
    icon: '❤️',
  },
  {
    display: 'Support Orion on Github',
    prompt:
      'Go to http://git.new/orion in current tab and star the repository',
    icon: '⭐',
  },
  {
