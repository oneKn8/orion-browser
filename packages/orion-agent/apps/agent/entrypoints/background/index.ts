...
import { Capabilities } from '@/lib/orion/capabilities'
import { getHealthCheckUrl, getMcpServerUrl } from '@/lib/orion/helpers'
import { openSidePanel, toggleSidePanel } from '@/lib/orion/toggleSidePanel'
import { checkAndShowChangelog } from '@/lib/changelog/changelog-notifier'
import {
  setupLlmProvidersBackupToOrion,
