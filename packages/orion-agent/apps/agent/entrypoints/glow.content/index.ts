...
const GLOW_OVERLAY_ID = 'orion-glow-overlay'
const GLOW_STYLES_ID = 'orion-glow-styles'
const GLOW_STOP_BTN_ID = 'orion-glow-stop-btn'
...
function injectStyles(): void {
  ...
  style.textContent = `
    ...
    @keyframes orion-glow-fade-in {
      from { opacity: 0; }
      to { opacity: ${GLOW_OPACITY}; }
    }

    @keyframes orion-glow-btn-fade-in {
      from { opacity: 0; }
      to { opacity: 1; }
    }
    ...
    #${GLOW_OVERLAY_ID} {
      ...
      will-change: opacity;
      animation:
        orion-glow-pulse 3s ease-in-out infinite,
        orion-glow-fade-in 420ms cubic-bezier(0.22, 1, 0.36, 1) forwards !important;
    }
    ...
    #${GLOW_STOP_BTN_ID} {
      ...
      opacity: 0;
      animation: orion-glow-btn-fade-in 420ms cubic-bezier(0.22, 1, 0.36, 1) forwards !important;
    }
