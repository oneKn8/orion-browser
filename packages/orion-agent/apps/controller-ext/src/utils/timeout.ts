...
/**
 * Timeout configuration for Chrome API and Orion operations.
...
export const CHROME_API_TIMEOUTS = {
  ...
  /** Orion page actions (click, scroll, input, etc.) */
  ORION_ACTION: 10_000,

  /** Heavy Orion operations (screenshot, snapshot, accessibility tree) */
  ORION_HEAVY: 60_000,
} as const
