...
import { CheckOrionAction } from '@/actions/diagnostics/CheckOrionAction'
...
export class OrionController {
  ...
  constructor(getPort: PortProvider) {
    logger.info('Initializing Orion Controller...')
  ...
  async start(): Promise<void> {
    logger.info('Starting Orion Controller...')
  ...
  stop(): void {
    logger.info('Stopping Orion Controller...')
  ...
  private registerActions(): void {
    ...
    this.actionRegistry.register('checkOrion', new CheckOrionAction())
