...
+            L"{CF887152-7CB8-4393-84CC-1BACF0EDE1D1}",  // Orion app GUID.
+        .base_app_name = L"Orion",              // A distinct base_app_name.
+        .base_app_id = L"Orion",                // A distinct base_app_id.
...
+            L"Orion HTML Document",  // Browser ProgID description.
+        .direct_launch_url_scheme = "orion",
+        .pdf_prog_id_prefix = L"BOSPDF",  // PDF ProgID prefix.
         .pdf_prog_id_description =
-            L"Chromium PDF Document",  // PDF ProgID description.
+            L"Orion PDF Document",  // PDF ProgID description.
         .active_setup_guid =
...
+        // Orion: custom CLSIDs for Windows integration
