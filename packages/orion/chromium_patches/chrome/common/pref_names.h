...
+// Orion: metrics prefs
+// String containing the stable client ID for Orion metrics
+inline constexpr char kOrionMetricsClientId[] =
+    "orion.metrics_client_id";
+
+// String containing the stable install ID for Orion metrics (Local State)
+inline constexpr char kOrionMetricsInstallId[] =
+    "orion.metrics_install_id";
+
+// NOTE: Other Orion prefs have been moved to
+// chrome/browser/orion/core/orion_prefs.h
+
 }  // namespace prefs
