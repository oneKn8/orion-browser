...
+const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("orion");
...
-const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chrome");
-const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chrome");
+const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("orion");
+const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("orion");
 #endif  // OS_*
