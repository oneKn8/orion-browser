diff --git a/chrome/utility/importer/orion/chrome_importer.h b/chrome/utility/importer/orion/chrome_importer.h
new file mode 100644
index 0000000000000..da685413cee76
--- /dev/null
+++ b/chrome/utility/importer/orion/chrome_importer.h
@@ -0,0 +1,45 @@
+// Copyright 2023 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_UTILITY_IMPORTER_ORION_CHROME_IMPORTER_H_
+#define CHROME_UTILITY_IMPORTER_ORION_CHROME_IMPORTER_H_
+
+#include <stdint.h>
+
...
+};
+
+#endif  // CHROME_UTILITY_IMPORTER_ORION_CHROME_IMPORTER_H_
