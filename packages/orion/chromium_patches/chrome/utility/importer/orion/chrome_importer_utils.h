diff --git a/chrome/utility/importer/orion/chrome_importer_utils.h b/chrome/utility/importer/orion/chrome_importer_utils.h
new file mode 100644
index 0000000000000..1a144725d2e89
--- /dev/null
+++ b/chrome/utility/importer/orion/chrome_importer_utils.h
@@ -0,0 +1,23 @@
+// Copyright 2024 AKW Technology Inc
+// Chrome importer shared utilities
+
+#ifndef CHROME_UTILITY_IMPORTER_ORION_CHROME_IMPORTER_UTILS_H_
+#define CHROME_UTILITY_IMPORTER_ORION_CHROME_IMPORTER_UTILS_H_
+
...
+}  // namespace orion_importer
+
+#endif  // CHROME_UTILITY_IMPORTER_ORION_CHROME_IMPORTER_UTILS_H_
