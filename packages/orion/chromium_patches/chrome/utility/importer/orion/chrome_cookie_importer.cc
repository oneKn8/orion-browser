diff --git a/chrome/utility/importer/orion/chrome_cookie_importer.cc b/chrome/utility/importer/orion/chrome_cookie_importer.cc
new file mode 100644
index 0000000000000..570f83ac1274c
--- /dev/null
+++ b/chrome/utility/importer/orion/chrome_cookie_importer.cc
@@ -0,0 +1,306 @@
...
+    LOG(WARNING) << "orion: Cookies not found at: " << cookies_path.value();
+    return cookies;
+  }
+
...
+    LOG(WARNING) << "orion: Failed to open Cookies database";
...
+        VLOG(1) << "orion: Skipping cookie " << entry.name << " on "
