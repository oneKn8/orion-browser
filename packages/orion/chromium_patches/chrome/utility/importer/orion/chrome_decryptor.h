diff --git a/chrome/utility/importer/orion/chrome_decryptor.h b/chrome/utility/importer/orion/chrome_decryptor.h
new file mode 100644
index 0000000000000..3805c007ec30c
--- /dev/null
+++ b/chrome/utility/importer/orion/chrome_decryptor.h
@@ -0,0 +1,45 @@
+// Copyright 2024 AKW Technology Inc
+// Chrome data decryption interface
+
+#ifndef CHROME_UTILITY_IMPORTER_ORION_CHROME_DECRYPTOR_H_
+#define CHROME_UTILITY_IMPORTER_ORION_CHROME_DECRYPTOR_H_
+
+#include <string>
+
...
+}  // namespace orion_importer
+
+#endif  // CHROME_UTILITY_IMPORTER_ORION_CHROME_DECRYPTOR_H_
