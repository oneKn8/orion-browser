diff --git a/chrome/browser/ui/webui/orion_welcome.h b/chrome/browser/ui/webui/orion_welcome.h
new file mode 100644
index 0000000000000..89503c57538ad
--- /dev/null
+++ b/chrome/browser/ui/webui/orion_welcome.h
@@ -0,0 +1,356 @@
+#ifndef CHROME_BROWSER_UI_WEBUI_ORION_WELCOME_H_
+#define CHROME_BROWSER_UI_WEBUI_ORION_WELCOME_H_
+
...
+
+class OrionWelcomeDataSource : public content::URLDataSource {
+ public:
+  OrionWelcomeDataSource() {}
+  OrionWelcomeDataSource(const OrionWelcomeDataSource&) = delete;
+  OrionWelcomeDataSource& operator=(const OrionWelcomeDataSource&) = delete;
+
...
+};
+
+std::string OrionWelcomeDataSource::GetSource() {
+  return "orion-welcome";
+}
+
+std::string OrionWelcomeDataSource::GetMimeType(const GURL& url) {
+  return "text/html";
+}
+
+std::string OrionWelcomeDataSource::GetContentSecurityPolicy(network::mojom::CSPDirectiveName directive) {
...
+}
+
+void OrionWelcomeDataSource::StartDataRequest(const GURL& url,
+                                    const content::WebContents::Getter& wc_getter,
...
+ <p>Orion is an AI-powered browser that lets you build and run agents to automate tedious tasks. It looks like Chrome but reimagined for the AI era.</p>
+</section>
+
+<section>
+ <div class="section-head"><span class="label">🚀 Getting Started</span></div>
+ <div style="text-align:center;">
+  <a class="btn btn-outline" href="https://github.com/oneKn8/orion-browser">
...
+   <p class="muted" style="margin-top:.35rem">Once setup completes (~1–2 min), visit <code>chrome://orion/settings</code> to configure your API keys.</p>
...
+   Step 3: All done!
+  </div>
+  <div class="muted" style="margin-top:.4rem">You're ready to use Orion, have fun! This page can be always accessed again at <a href="chrome://orion-welcome"><code>chrome://orion-welcome</code></a></div>
+ </div>
+</section>
+
+<section>
...
+   Discord
+  </a>
+  <a href="https://github.com/oneKn8/orion-browser">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>GitHub</title>
...
+   GitHub
+  </a>
+  <a href="https://dub.sh/orion-slack">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>Slack</title>
...
+   Slack
+  </a>
+  <a href="https://x.com/orion_browser">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>X</title>
...
+
+class OrionWelcome;
+class OrionWelcomeUIConfig : public content::DefaultWebUIConfig<OrionWelcome> {
+  public:
+   OrionWelcomeUIConfig() : DefaultWebUIConfig("chrome", "orion-welcome") {}
+};
+
+class OrionWelcome : public content::WebUIController {
+ public:
+  OrionWelcome(content::WebUI* web_ui) : content::WebUIController(web_ui) {
+    content::URLDataSource::Add(Profile::FromWebUI(web_ui), std::make_unique<OrionWelcomeDataSource>());
+  }
+  OrionWelcome(const OrionWelcome&) = delete;
+  OrionWelcome& operator=(const OrionWelcome&) = delete;
+};
+
+#endif  // CHROME_BROWSER_UI_WEBUI_ORION_WELCOME_H_
