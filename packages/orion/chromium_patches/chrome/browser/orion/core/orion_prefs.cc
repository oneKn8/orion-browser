diff --git a/chrome/browser/orion/core/orion_prefs.cc b/chrome/browser/orion/core/orion_prefs.cc
new file mode 100644
index 0000000000000..c191fb3963968
--- /dev/null
+++ b/chrome/browser/orion/core/orion_prefs.cc
@@ -0,0 +1,96 @@
...
+    pref_service->SetBoolean(::prefs::kVerticalTabsEnabled, orion_enabled);
+  }
+}
+
