diff --git a/chrome/browser/orion/server/process_controller_impl.h b/chrome/browser/orion/server/process_controller_impl.h
new file mode 100644
index 0000000000000..46f7d9359dcd7
--- /dev/null
+++ b/chrome/browser/orion/server/process_controller_impl.h
@@ -0,0 +1,35 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ORION_SERVER_PROCESS_CONTROLLER_IMPL_H_
+#define CHROME_BROWSER_ORION_SERVER_PROCESS_CONTROLLER_IMPL_H_
+
...
+}  // namespace orion
+
+#endif  // CHROME_BROWSER_ORION_SERVER_PROCESS_CONTROLLER_IMPL_H_
