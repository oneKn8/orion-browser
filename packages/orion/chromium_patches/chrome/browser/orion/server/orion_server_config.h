diff --git a/chrome/browser/orion/server/orion_server_config.h b/chrome/browser/orion/server/orion_server_config.h
new file mode 100644
index 0000000000000..3b121ed6f6635
--- /dev/null
+++ b/chrome/browser/orion/server/orion_server_config.h
@@ -0,0 +1,90 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ORION_SERVER_ORION_SERVER_CONFIG_H_
+#define CHROME_BROWSER_ORION_SERVER_ORION_SERVER_CONFIG_H_
+
+#include <string>
+
...
+
+  // Runtime data directory (~/.orion or equivalent).
...
+}  // namespace orion
+
+#endif  // CHROME_BROWSER_ORION_SERVER_ORION_SERVER_CONFIG_H_
