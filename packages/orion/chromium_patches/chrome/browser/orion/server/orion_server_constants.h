diff --git a/chrome/browser/orion/server/orion_server_constants.h b/chrome/browser/orion/server/orion_server_constants.h
new file mode 100644
index 0000000000000..d2c8229f8c805
--- /dev/null
+++ b/chrome/browser/orion/server/orion_server_constants.h
@@ -0,0 +1,52 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ORION_SERVER_ORION_SERVER_CONSTANTS_H_
+#define CHROME_BROWSER_ORION_SERVER_ORION_SERVER_CONSTANTS_H_
+
...
+    "https://cdn.orion-browser.local/appcast-server.xml";
+inline constexpr char kAlphaAppcastUrl[] =
+    "https://cdn.orion-browser.local/appcast-server.alpha.xml";
+
...
+}  // namespace orion_server
+
+#endif  // CHROME_BROWSER_ORION_SERVER_ORION_SERVER_CONSTANTS_H_
