diff --git a/chrome/browser/orion/server/orion_server_config.cc b/chrome/browser/orion/server/orion_server_config.cc
new file mode 100644
index 0000000000000..3e0c69cdf6442
--- /dev/null
+++ b/chrome/browser/orion/server/orion_server_config.cc
@@ -0,0 +1,81 @@
