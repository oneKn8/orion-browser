diff --git a/chrome/browser/orion/server/health_checker.h b/chrome/browser/orion/server/health_checker.h
new file mode 100644
index 0000000000000..1cefa3ec91f42
--- /dev/null
+++ b/chrome/browser/orion/server/health_checker.h
@@ -0,0 +1,33 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ORION_SERVER_HEALTH_CHECKER_H_
+#define CHROME_BROWSER_ORION_SERVER_HEALTH_CHECKER_H_
+
...
+}  // namespace orion
+
+#endif  // CHROME_BROWSER_ORION_SERVER_HEALTH_CHECKER_H_
