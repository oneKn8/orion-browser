diff --git a/chrome/browser/orion/server/orion_server_proxy.h b/chrome/browser/orion/server/orion_server_proxy.h
new file mode 100644
index 0000000000000..586296d473849
--- /dev/null
+++ b/chrome/browser/orion/server/orion_server_proxy.h
@@ -0,0 +1,79 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ORION_SERVER_ORION_SERVER_PROXY_H_
+#define CHROME_BROWSER_ORION_SERVER_ORION_SERVER_PROXY_H_
+
+#include <memory>
+#include <optional>
+#include <string>
...
+class OrionServerProxy : public net::HttpServer::Delegate {
+ public:
+  OrionServerProxy();
+  ~OrionServerProxy() override;
+
+  OrionServerProxy(const OrionServerProxy&) = delete;
+  OrionServerProxy& operator=(const OrionServerProxy&) = delete;
+
...
+}  // namespace orion
+
+#endif  // CHROME_BROWSER_ORION_SERVER_ORION_SERVER_PROXY_H_
