diff --git a/chrome/browser/orion/server/test/mock_process_controller.h b/chrome/browser/orion/server/test/mock_process_controller.h
new file mode 100644
index 0000000000000..97fdf04282691
--- /dev/null
+++ b/chrome/browser/orion/server/test/mock_process_controller.h
@@ -0,0 +1,38 @@
+// Copyright 2024 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_ORION_SERVER_TEST_MOCK_PROCESS_CONTROLLER_H_
+#define CHROME_BROWSER_ORION_SERVER_TEST_MOCK_PROCESS_CONTROLLER_H_
+
...
+}  // namespace orion
+
+#endif  // CHROME_BROWSER_ORION_SERVER_TEST_MOCK_PROCESS_CONTROLLER_H_
