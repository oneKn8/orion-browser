...
+
+  // Always force-pin Orion extensions that are marked pinned.
+  for (const auto& extension_id : orion::GetOrionExtensionIds()) {
+    if (orion::IsOrionPinnedExtension(extension_id)) {
