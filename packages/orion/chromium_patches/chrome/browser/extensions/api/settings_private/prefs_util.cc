...
+  // Orion prefs (all in orion::prefs namespace)
+  (*s_allowlist)[orion::prefs::kProviders] =
+      settings_api::PrefType::kString;
+  (*s_allowlist)[orion::prefs::kCustomProviders] =
+      settings_api::PrefType::kString;
+  (*s_allowlist)[orion::prefs::kShowToolbarLabels] =
+      settings_api::PrefType::kBoolean;
+  (*s_allowlist)[orion::prefs::kShowLLMChat] =
+      settings_api::PrefType::kBoolean;
+  (*s_allowlist)[orion::prefs::kShowLLMHub] =
+      settings_api::PrefType::kBoolean;
+
