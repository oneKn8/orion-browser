...
+class OrionChangeDetector : public content::WebContentsObserver {
+ public:
...
+  explicit OrionChangeDetector(content::WebContents* web_contents);
+  ~OrionChangeDetector() override;
+
+ private:
+  OrionChangeDetector(const OrionChangeDetector&) = delete;
+  OrionChangeDetector& operator=(const OrionChangeDetector&) = delete;
+
...
+  base::WeakPtrFactory<OrionChangeDetector> weak_factory_{this};
+};
+
+}  // namespace api
+}  // namespace extensions
