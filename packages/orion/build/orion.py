#!/usr/bin/env python3
"""
Orion Build System - Main Entry Point

Unified CLI for building, developing, and releasing Orion browser.
...
Usage:
    ...
    # As module:
    python -m build.orion build --help
"""
import typer
...
app.add_typer(build_app, name="build", help="Build Orion browser")
