# Orion Icon Generation

This directory contains the unified icon generation system for Orion. All browser icons
...
# 4. Icons are output to packages/orion/resources/icons/
```
...
3. **Build Orion**: The `copy_resources.yaml` copies generated icons to chromium source tree
