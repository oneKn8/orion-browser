#!/usr/bin/env python3
"""Release CLI - Modular release automation for Orion"""
...
def main(
    ...
    """Release automation for Orion

    \b
    Quick Operations (Flags):
      orion release --list                        # List all available versions
      orion release --list --version 0.31.0       # List artifacts for version
      orion release --version 0.31.0 --appcast    # Generate appcast XML
      orion release --version 0.31.0 --publish    # Publish to download/ paths
      orion release --version 0.31.0 --download   # Download all artifacts
      orion release --version 0.31.0 --download --os macos  # Download macOS only
      orion release --version 0.31.0 --download --output ./downloads  # Custom dir

    \b
    GitHub Release (Sub-command):
      orion release github create --version 0.31.0
      orion release github create --version 0.31.0 --publish

    \b
    Show Available Modules:
      orion release --show-modules
    """
    if show_modules:
...
def github_create(
    ...
    Examples:
      orion release github create --version 0.31.0
      orion release github create --version 0.31.0 --publish  # Also publish to download/
      orion release github create --version 0.31.0 --no-draft # Create published release
    """
