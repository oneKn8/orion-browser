...
def sign_macos_binary(
    ...
    cmd = [
        ...
        "--force",
        "--timestamp",
        "--identifier", f"com.orion.{binary_path.stem}",
        "--options", "runtime",
    ]
...
def get_entitlements_path(root_dir: Path) -> Optional[Path]:
    ...
    candidates = [
        root_dir / "resources" / "entitlements" / "orion-executable-entitlements.plist",
        root_dir / "packages" / "orion" / "resources" / "entitlements" / "orion-executable-entitlements.plist",
    ]
