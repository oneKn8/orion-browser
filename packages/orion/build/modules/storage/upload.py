#!/usr/bin/env python3
"""Upload module for Orion build artifacts to Cloudflare R2"""
...
def generate_release_json(
    ...
    release_data = {
        ...
        "orion_chromium_version": ctx.orion_chromium_version,
...
def _get_artifact_key(filename: str, platform: str) -> str:
    ...
    Examples:
        Orion_v0.31.0_arm64.dmg -> arm64
        Orion_v0.31.0_x64.dmg -> x64
        Orion_v0.31.0_x64_installer.exe -> x64_installer
        Orion_v0.31.0_x64.AppImage -> x64_appimage
        orion_0.31.0_amd64.deb -> x64_deb
    """
