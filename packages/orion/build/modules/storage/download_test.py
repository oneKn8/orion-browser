#!/usr/bin/env python3
"""Tests for Orion resource artifact downloads."""
...
class ExtractArtifactZipTest(unittest.TestCase):
    def test_extracts_declared_files_and_writes_metadata(self) -> None:
        files = {
            "resources/bin/orion_server": b"server-binary",
    ...
    def test_rejects_missing_declared_files(self) -> None:
        ...
        metadata_override = {
            ...
            "files": [
                {
                    "path": "resources/bin/orion_server",
                    "sha256": hashlib.sha256(files["resources/bin/orion_server"]).hexdigest(),
                    "size": len(files["resources/bin/orion_server"]),
                },
                {
