#!/usr/bin/env python3
"""String replacement module for Orion build system"""
...
branding_replacements = [
    (
        ...
        r"The Orion Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The Orion Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"Orion Browser"),
    (r"Google Chrome", r"Orion"),
    (r"(Google)(?! Play)", r"Orion"),
    (r"Chromium", r"Orion"),
    (r"Chrome", r"Orion"),
]
